...
// Este componente se monta solo cuando el usuario ya se autenticó exitosamente.
// Su trabajo es enviar los datos a RDS y luego redirigir.
  ...
  useEffect(() => {
    const syncData = async () => {
      try {
        ...
        // (podría ser que ya exista el perfil)
        navigate('/dashboard');
      }
    };
    syncData();
